<template>
  <div>
    ...
    <Textbox message= "Classification" :maxLen="50" @getText = "ChangeClas"/>
    <br>
    <br>
    <Textbox message= "Email" :maxLen="360" @getText = "ChangeEma"/>
    <Textbox message= "GPA" :maxLen="5" @getText = "ChangeGpa"/>
    <br>
    <br>
    <Textbox message= "GitHub" :maxLen="39" @getText = "ChangeGit"/>
    ...
    async Click() {
      if(this.Send == "New")
      {
        try
        {
          ...
          await fetch("http://167.99.6.44:8004/addstudent", options);
          // const response = await fetch("http://167.99.6.44:8004/addstudent", options);
      ...
      else if(this.Send == "Update")
      {
        ...
        const get = await fetch("http://167.99.6.44:8004/studentsnum/" + this.Semester + "/" + this.Mnum, sender);
        ...
        if(stuff.result.length != 0)
        {
          ...
          await fetch("http://167.99.6.44:8004/editstudent", options);
          // const response = await fetch("http://167.99.6.44:8004/editstudent", options);
          // const data = await response.json();
          this.ErrorMessage = "Success!"
        }
        else
